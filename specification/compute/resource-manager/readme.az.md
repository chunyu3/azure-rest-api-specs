...
cli:
  cli-directive:
    - where:
        group: 'CapacityReservationGroups'
        op: ListBySubscription|ListByResourceGroup|Get
    ...
    - where:
      ...
      hidden: false
    - where:
        group: 'CapacityReservations'
        op: ListByCapacityReservationGroup|Get
        apiVersion: '2021-04-01'
      hidden: false
    - where:
        group: 'DiskAccesses'
