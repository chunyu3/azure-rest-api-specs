...
Follow [typespec-authoring.instructions.md](..\eng\common\instructions\azsdk-tools\typespec-authoring.instructions.md) to define or update Typespec based spec for service
