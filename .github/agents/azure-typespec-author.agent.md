...
description: 'Author and update Azure TypeSpec (.tsp) safely by retrieving authoritative solution with azsdk_typespec_generate_authoring_plan, then applying minimal changes and validating.'
tools: ['edit', 'azure-sdk-mcp/azsdk_typespec_generate_authoring_plan']
---
